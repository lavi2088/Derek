...
<div id='cssmenu'>
<ul>
   <li class='sc'><a href='PostHomePage.php' class="mark"><span>Posts</span><img src="menu_assets/images/postIcon.png" alt="post" style="float:right; margin-right:10px" /></a></li>
   <li><a href='ActiveUsers.php'><span>Active Users</span><img src="menu_assets/images/activeUserIcon.png" alt="post" style="float:right; margin-right:10px" /></a></li>
   ...
   <li><a href='AddNewPackage.php'><span>Social Posts</span><img src="menu_assets/images/SocialPostIcon.png" alt="post" style="float:right; margin-right:10px" /></a></li>
    ...
    <div id="right">
	  ...
	  <table><tr>
	  <td><img src="menu_assets/images/blueIcon.png" /></td><td><h2 style="color:#3f8bea">&nbsp;&nbsp;&nbsp;&nbsp;User Post Registration</h2></td></tr>
	  </table>
	  </div>
	  ...
	  <div class="postDiv">
<br />
	  <h2 style="margin:10px">Post Point Control Panel</h2>
