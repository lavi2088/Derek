...
$sql="SELECT * FROM $tbl_name WHERE status='N' ORDER BY date DESC";
...
<html lang="en">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            <li class="active"><a href="w_dashboardhome.php"><i class="fa fa-dashboard"></i> Home</a></li>
	  ...
	  <div class="row">
          <div class="col-lg-12">
            <h1><?php echo $appname; ?> <small>Home</small></h1>
            <ol class="breadcrumb">
              <li><a href="w_dashboardhome.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              <li class="active"><i class="fa fa-edit"></i> Home</li>
            </ol>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="span6" colspan="2">
                                        <span class="line"></span>Points pending
                                    </th>
                                    <th class="span3" colspan="1">
